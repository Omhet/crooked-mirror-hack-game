export function canvasCompare(params) {
  ...
  return readImages(instance).then(onReadImages).catch(panic);
...
function isNonEmptyString(item) {
  return toStringCall(item) === "[object String]" && item.length > 0;
}
